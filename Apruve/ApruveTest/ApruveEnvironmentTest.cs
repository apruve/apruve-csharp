...
namespace ApruveTest
{
    ...
    public class ApruveEnvironmentTest
    {
        ...
        {
            Assert.AreEqual("https://app.apruve.com", ApruveEnvironment.prodEnvironment().getBaseUrl());
        ...
        {
            Assert.AreEqual("https://app.apruve.com/js/apruve.js", ApruveEnvironment.prodEnvironment().getJsUrl());
        ...
        {
            Assert.AreEqual("<script src=\"https://app.apruve.com/js/apruve.js\" type=\"text/javascript\"></script>", ApruveEnvironment.prodEnvironment().getJsTag());
